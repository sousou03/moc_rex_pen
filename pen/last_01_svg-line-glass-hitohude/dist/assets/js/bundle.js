...
/***/ (function(module, exports) {
	...
	var SVGLineHover = function () {
	  function SVGLineHover($target) {
	    _classCallCheck(this, SVGLineHover);
	  ...
	  _createClass(SVGLineHover, [{
	    ...
	    value: function onEnter(that) {
	      ...
	      tl.set(this.$circleWrap, { rotationZ: -310 }, 0.0).set(this.$circle, { drawSVG: '0%' }, 0.0).set(this.$line, { drawSVG: '0%' }, 0.0).to(this.$circle, 1.0, {
	        drawSVG: '100%',
	        ease: Expo.easeOut
	      }, 0.0).to(this.$line, 0.3, {
	        drawSVG: '100%',
	        ease: Power4.easeOut
	      }, 0.55);
	    }
