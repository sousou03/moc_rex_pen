...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _LineBox = __webpack_require__(36);
	
	var _LineBox2 = _interopRequireDefault(_LineBox);
	  ...
	  _createClass(SpanText, [{
	    ...
	    value: function ready() {
	      ...
	      this.$span.each(function (index, el) {
	        ...
	        var l = new _LineBox2.default($(el));
	        _this.ls.push(l);
	      });
	...
	var SpanText = function () {
	  ...
	  _createClass(SpanText, [{
	    ...
	    value: function set($target) {
	      ...
	      // span化
	      for (var i = 0; i < span.length; i++) {
	        span[i] = span[i].replace(/(\S)/g, '<span class="oh"><span class="t">$1</span></span>');
	      }
