	...
	var Controller = function (_Base) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      this.dataText = ["Shun Kawakami est classe et inclassable,<br>alors les marques l’ont remarqué", "Rana extractive Rana extractive<br>Rana extractive Rana extractive", "SOICHIRO FUJII<br>SOICHIRO FUJII", "OKAMURA OKAMURA<br>OKAMURA OKAMURA"
	      // "Rana extractive",
	      // "Pen International",
	      ];
	    ...
	    value: function typing(text, i) {
	      ...
	      // type text
	      if (i < text.length) setTimeout(function () {
	        _this2.typing(text, index);
	      }, this.typespeed);
	    }
	  }, {
	    key: 'startTextAnimation',
	    value: function startTextAnimation(i) {
	
	      this.typing(this.dataText[i], 0);
	    }
	  }, {
	    key: 'clear',
	    value: function clear(i) {
	      var _this3 = this;
	      ...
	      // 文字が0以上なら、さらに消す
	      if (newx.length > 0) setTimeout(function () {
	        _this3.clear(i);
	      }, this.clearspeed);
	    }
	  }, {
