...
/***/ (function(module, exports, __webpack_require__) {
	...
	var e = _interopRequireWildcard(_index3);
	...
	var SpanText = function (_Base) {
	  _inherits(SpanText, _Base);
	
	  function SpanText($wrap) {
	    _classCallCheck(this, SpanText);
	
	    var _this = _possibleConstructorReturn(this, (SpanText.__proto__ || Object.getPrototypeOf(SpanText)).call(this));
	
	    _this.$wrap = $wrap;
	    _this.$target = $wrap.find('div');
	  ...
	  _createClass(SpanText, [{
	    ...
	    value: function ready() {
	      ...
	      this.$span.each(function (index, el) {
	        ...
	        TweenMax.set(_this2.$spano.eq(index), { width: w, height: h });
	      });
	    ...
	    value: function show(index) {
	      ...
	      tl.add(function () {
	        _this3.$spano.eq(index).addClass('flashD');
	      }, 0.0).add(function () {
	        TweenMax.set(_this3.$spant.eq(index), { opacity: 1 });
	      }, dur * times);
	    }
	  }, {
	    key: 'hide',
