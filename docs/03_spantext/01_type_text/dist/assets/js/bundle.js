	...
	var Controller = function (_Base) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      this.dataText = ["Shun Kawakami est classe et inclassable,<br>alors les marques l’ont remarqué", "Rana extractive Rana extractive<br>Rana extractive Rana extractive", "Rana extractive Rana extractive<br>Rana extractive Rana extractive"
	      // "Rana extractive",
	      // "Pen International",
	      ];
	    ...
	    key: 'typing',
	    value: function typing(text, i, cb) {
	      var _this2 = this;
	    ...
	    value: function startTextAnimation(i) {
	      ...
	      if (typeof this.dataText[i] == 'undefined') {
	        ...
	        this.typing(this.dataText[i], 0, function () {
