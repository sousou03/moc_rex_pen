...
/***/ (function(module, exports) {
	...
	var data = function data() {
	  ...
	  return [{
	    ...
	    'key': 'motion',
	    'def': 'normal',
	    'value': ['bottomToUp', 'bottomToUpandRightToLeft', 'bottomToUpandRightToLeft-pile']
	  }, {
	    'key': 'param01',
	    'def': '1',
	    'value': ['any']
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Controller5 = __webpack_require__(38);
	  ...
	  _createClass(SpanText, [{
	    ...
	    value: function ready() {
	      ...
	      this.$span.each(function (index, el) {
	        ...
	        TweenMax.set(_this.$span.eq(index), { x: w });
	      });
	    }
	  }, {
	    key: 'show',
	    value: function show() {
	      ...
	      this.$span.each(function (index, el) {
	        ...
	        TweenMax.to(_this2.$span.eq(index), 1.2, {
	          opacity: 1,
	          x: 0,
	          ease: Power3.easeOut,
	          delay: index * 0.01
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SetSpan = __webpack_require__(39);
	...
	var SpanText = function () {
	  ...
	  _createClass(SpanText, [{
	    ...
	    value: function ready() {
	      ...
	      // y
	      this.$spany.each(function (index, el) {
	
	        TweenMax.set(_this.$spany.eq(index), { y: h });
	      });
	
	      // x
	      this.$spanx.each(function (index, el) {
	
	        TweenMax.set(_this.$spanx.eq(index), { x: w });
	      });
	    }
	  }, {
	    key: 'show',
	    value: function show() {
	      ...
	      this.$spany.each(function (index, el) {
	        ...
	        TweenMax.to(_this2.$spany.eq(index), 1.2, {
	          opacity: 1,
	          y: 0,
	          ease: Expo.easeOut,
	          delay: index * 0.01
	      ...
	      this.$spanx.each(function (index, el) {
	        ...
	        TweenMax.to(_this2.$spanx.eq(index), 1.2, {
	          opacity: 1,
	          x: 0,
	          ease: Expo.easeOut,
	...
	var SpanText = function () {
	  ...
	  _createClass(SpanText, [{
	    ...
	    value: function set($target) {
	      ...
	      // span化
	      for (var i = 0; i < span.length; i++) {
	        span[i] = span[i].replace(/(\S)/g, '<span class="oh"><span class="y">$1</span><span class="x">$1</span></span>');
	      }
