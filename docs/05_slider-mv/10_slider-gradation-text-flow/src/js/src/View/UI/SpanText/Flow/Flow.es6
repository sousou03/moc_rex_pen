...
export default class Dom {
  ...
  setup() {
    ...
    // pos ready
    var x = gb.r.w * (Math.random() - 2.0) * 2;
    var y = gb.r.h * (Math.random() - 0.5) * 0.5;
    var z = gb.r.h * (Math.random() - 0.5) * 0.5;
  ...
  hide(delay) {
    ...
    var x = gb.r.w * (Math.random() + 1.0) * 2;
    var y = gb.r.h * (Math.random() - 0.5) * 0.5;
    var z = gb.r.h * (Math.random() - 0.5) * 0.5;
    var rotx = 360 * (Math.random() - 0.5);
    var roty = 360 * (Math.random() - 0.5);
