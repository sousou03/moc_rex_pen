...
export default class Bubble extends Base {
  ...
  show() {
    ...
    tl
      ...
      }, this.dur / this.divide * 0)
      .to(this, this.dur, {
        op2: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 1)
      .to(this, this.dur, {
        op3: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 2)
      .to(this, this.dur, {
        op4: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 3)
      .to(this, this.dur, {
        op5: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 4)
      .to(this, this.dur, {
        op6: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 5)
      .to(this, this.dur, {
        op7: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 6)
      .to(this, this.dur, {
        op8: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 7)
      .to(this, this.dur, {
        op9: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 8)
      .to(this, this.dur, {
        op10: 0,
        ease: Power1.easeInOut,
      }, this.dur / this.divide * 9)
      .to(this, this.dur, {
        op11: 0,
        ease: Power1.easeInOut,
