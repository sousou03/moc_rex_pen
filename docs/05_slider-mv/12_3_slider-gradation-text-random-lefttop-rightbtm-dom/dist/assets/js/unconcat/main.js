	...
	var Controller = function (_Base) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function setup() {
	      ...
	      this.slider = new _Controller2.default();
	      this.st1 = new _Controller4.default($('.text01'));
	      this.st2 = new _Controller4.default($('.text02'));
	      this.st3 = new _Controller4.default($('.text03'));
	      this.st4 = new _Controller4.default($('.text04'));
	      this.sts = [];
	    ...
	    value: function timeline() {
	      ...
	      .add(function () {
	        ...
	        _this2.sts[_this2.index].hide();
	        _this2.index++;
	        _this2.index = _this2.index % _this2.sts.length;
	      }, 0.0)
	      // hide
	      .add(function () {
	
	        _this2.sts[_this2.index].show();
	        _this2.$item.removeClass('active');
	        _this2.$item.eq(_this2.index).addClass('active');
	        var tl = new TimelineMax();
	        tl.add(function () {
	          _this2.slider.next();
	        }, 0.3);
	      }, 1.0).add(function () {}, 5.0);
	    }
	  }, {
	    key: 'onResize',
	    value: function onResize() {}
	...
	var Render = function (_Base) {
	  ...
	  _createClass(Render, [{
	    ...
	    value: function next(current, _next, prev) {
	      ...
	      tl.set(this.$item.eq(current), {
	        x: x,
	        opacity: 0,
	        zIndex: 2
	      }, 0.0).set(this.$item.eq(prev), {
	        zIndex: 1
	      }, 0.0).to(this.$item.eq(current), 2.0, {
	        x: 0,
	        opacity: 1,
	        ease: Power4.easeOut
	      }, 0.0).to(this.$item.eq(prev), 2.0, {
	        // x: -x,
	        opacity: 0,
	        ease: Power2.easeInOut
	      }, 0.5);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SetSpan = __webpack_require__(37);
